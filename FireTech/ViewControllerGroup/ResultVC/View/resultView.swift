...
class resultView: UIView {
   ...
   //
    ...
    func creatingElementInView(_ VC: UIView){
        ...
        case 5:
            VC.creatingElements([labelFirefighterOne,
                                 labelFirefighterTwo,
    ...
    func arrangementOfElementInView(_ VC: UIView){
        ...
        print("Bar: \(FirefighterOne), Name: \(StringFirefighterOne )")
        ...
        case 3:
            ...
            fallthrough
        case 2:
            labelFirefighterOne.positionOfElements(VC.safeAreaLayoutGuide.topAnchor, 20,
                                                   VC.leadingAnchor, 10,
            ...
            labelFirefighterTwo.positionOfElements(labelFirefighterOne.bottomAnchor, 0,
                                                   ...
                                                   labelFirefighterOne.trailingAnchor, 0,
                                                   nil, 0)
            print("Result  = \(StringFirefighterOne)")
            ...
            print(StringFirefighterOne)
            default:
            break
        }
        switch numberOfFirefighters {
        case 2:
            labelTimeWork.positionOfElements(labelFirefighterTwo.bottomAnchor, 10,
                                             labelFirefighterOne.leadingAnchor, 0,
                                             labelFirefighterOne.trailingAnchor, 0,
                                             nil, 0)
        case 3:
            labelTimeWork.positionOfElements(labelFirefighterThree.bottomAnchor, 10,
                                             labelFirefighterOne.leadingAnchor, 0,
                                             labelFirefighterOne.trailingAnchor, 0,
                                             nil, 0)
        case 4:
            labelTimeWork.positionOfElements(labelFirefighterFour.bottomAnchor, 10,
                                             labelFirefighterOne.leadingAnchor, 0,
                                             labelFirefighterOne.trailingAnchor, 0,
                                             nil, 0)
        case 5:
            labelTimeWork.positionOfElements(labelFirefighterFive.bottomAnchor, 10,
                                             labelFirefighterOne.leadingAnchor, 0,
                                             labelFirefighterOne.trailingAnchor, 0,
                                             nil, 0)
        default:
        ...
        labelExitCommand.positionOfElements(labelTimeWork.bottomAnchor,10,
                                            labelFirefighterOne.leadingAnchor, 0,
                                            labelFirefighterOne.trailingAnchor, 0,
                                            nil, 0)
        labelTimeExitAndWork.positionOfElements(labelExitCommand.bottomAnchor, 10,
                                                labelFirefighterOne.leadingAnchor, 0,
                                                labelFirefighterOne.trailingAnchor, 0,
                                                nil, 0)
        labelPressure.positionOfElements(labelTimeExitAndWork.bottomAnchor, 10,
                                         labelFirefighterOne.leadingAnchor, 0,
                                         labelFirefighterOne.trailingAnchor, 0,
                                         nil, 0)
    }
